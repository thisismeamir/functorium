...
Giving an overview of the current (from 2000s until now), then talking about the pillars of research in this area, mainly numerical relativity, theoretical gravitational waves, and data analysis of observations.
After that we'd start by mapping the current studies, their features, citation and status of the community.
These all would play a good role in our understanding, in our next chapter we'll discuss our opportunity, ideas, and gaps that our study can fill.
